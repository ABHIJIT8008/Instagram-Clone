...
const Profile = () => {
    ...
    const handleDeletePost = async (postId) => {
        ...
        try {
            ...
            // 3. Update UI instantly (Remove post from list)
            setProfile(prev => ({
                ...prev,
    ...
    return (
        <div className="max-w-4xl mx-auto pt-8 px-4">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 border-b border-gray-300 pb-10 mb-10">
                ...
                <div className="flex-1 text-center md:text-left">
                        ...
                        {!isOwnProfile && (
                            <button 
                                ...
                                className={`px-6 py-1.5 rounded font-semibold text-sm border ${
                                    isFollowing ? 'bg-white text-black border-gray-300' : 'bg-blue-500 text-white border-transparent'
                                }`}
                            >
                    ...
                    <div className="flex justify-center md:justify-start gap-8 mb-4">
                        <span className="font-semibold">{profile.posts.length} <span className="font-normal">posts</span></span>
            ...
            {/* Post Grid Section */}
            <div className="grid grid-cols-3 gap-1 md:gap-4 mb-10">
                {profile.posts.length > 0 ? (
                    profile.posts.map(post => (
                        <div key={post._id} className="relative aspect-square group bg-gray-100">
                            <img 
                                src={post.imageUrl} 
                                alt="post" 
                            ...
                            {/* DELETE BUTTON OVERLAY (Only for owner) */}
                            {isOwnProfile && (
                                <button
